    ...
    <div class="container">
        <div class="flex">
            ...
            <ul class="navbar-menu">
                <li data-aos="fade-left" data-aos-delay="100">
                    <a class="fade-page" href="{{ url('/') }}">Home</a>
                </li>
                <li data-aos="fade-left" data-aos-delay="100">
                    <a class="fade-page" href="{{ url('/packages') }}">Prices</a>
                </li>
                <li data-aos="fade-left" data-aos-delay="100">
                    <a class="fade-page" href="{{ url('/about') }}">About</a>
                </li>
                ...
                <li data-aos="fade-left" data-aos-delay="400">
                    <a class="fade-page" href="{{ url('/contact') }}">Support</a>
                </li>
            </ul>
        </div>
        <div class="level-right">
            ...
            <div class="mobile-menu">
                ...
                <ul>
                    <li><a class="fade-page" href="{{ url('/') }}">Home</a></li>
                    <li><a class="fade-page" href="{{ url('/packages') }}">Prices</a></li>
                    <li><a class="fade-page" href="{{ url('/about') }}">About</a></li>
                    <li><a class="fade-page" href="{{ url('/contact') }}">Contact us</a></li>
                </ul>
            </div>
            <div class="flex">
